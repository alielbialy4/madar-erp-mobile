...
type Props = {
  ...
  onFiltersChange: (next: CategoryListFilters) => void;
  onOpenFilters?: () => void;
  canManage?: boolean;
  onAdd?: () => void;
...
export function CategoriesListToolbar({
  query,
  onQueryChange,
  filters,
  onFiltersChange,
  ...
  const chips = useMemo(() => getActiveCategoryFilterChips(filters), [filters]);
