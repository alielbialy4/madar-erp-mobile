...
export function DashboardKpiCard({ label, value, hint, icon, wide, tier = 'primary' }: Props) {
  const c = useColors();
    ...
    >
      <View style={[styles.card, { backgroundColor: c.surface, borderColor: c.border }]}>
        <View style={styles.heading}>
          ...
          <View style={[styles.icon, dense && { width: sizing.iconBox, height: sizing.iconBox }]}>
            <AppIcon
...
const styles = StyleSheet.create({
  ...
  value: { ...textLtr, fontFamily: fonts.extraBold, fontWeight: '800', fontSize: typography.financialValue, lineHeight: 28, fontVariant: ['tabular-nums'] },
