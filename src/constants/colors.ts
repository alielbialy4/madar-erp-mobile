...
/** Static brand/print palette. Components should consume useColors where theme-aware values are needed. */
...
export const lightColors: AppColors = {
  ...
  softPrimary: '#F1F5F9',
  softPrimaryBorder: '#CBD5E1',
  softDanger: '#FEF1F1',
  softDangerBorder: '#FED7D7',
  softWarning: '#FFFBEB',
  softWarningBorder: '#FDE68A',
  softSuccess: '#ECFDF5',
  softSuccessBorder: '#A7F3D0',
  softInfo: '#EFF6FF',
  softInfoBorder: '#BFDBFE',
  softNeutral: '#F1F5F9',
  softNeutralBorder: '#E2E8F0',
...
export const darkColors: AppColors = {
  ...
  background: '#0B1120',
  surface: '#111827',
  surfaceHeader: '#0D1320',
  surfaceMuted: '#1E293B',
  surfaceElement: '#1E293B',
  surfaceHover: '#334155',
  ...
  softPrimary: '#1E293B',
  softPrimaryBorder: '#475569',
  softDanger: '#3A1A1A',
  softDangerBorder: '#7A1A1A',
  softWarning: '#3A2A10',
  softWarningBorder: '#6A4510',
  softSuccess: '#0A3A20',
  softSuccessBorder: '#105830',
  softInfo: '#152040',
  ...
  primarySoftMuted: '#111827',
  primarySoftForeground: '#F1F5F9',
  primarySoftBorder: '#475569',
  icon: '#94A3B8',
