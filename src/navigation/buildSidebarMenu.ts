...
export const SIDEBAR_MENU_TEMPLATE: SidebarMenuItem[] = [
 ...
 link: '/employees',
 perm: ['manage_employees', 'manage_users'],
 },
 {
 id: 'nav-employees-attendance',
 label: 'employees.tabs.attendance',
 icon: 'ri-calendar-check-line',
 link: '/employees?tab=attendance',
 perm: 'manage_attendance',
 branchOnly: true,
 },
 {
 id: 'nav-employees-attendance-records',
 label: 'employees.tabs.attendanceRecords',
 icon: 'ri-file-list-3-line',
 link: '/employees?tab=attendance-records',
 perm: 'manage_attendance',
 },
 {
 id: 'nav-employees-adjustments',
 label: 'employees.tabs.adjustments',
 icon: 'ri-funds-line',
 link: '/employees?tab=adjustments',
 perm: 'manage_payroll_adjustments',
 },
 {
 id: 'nav-employees-payroll',
 label: 'employees.tabs.payroll',
 icon: 'ri-money-dollar-circle-line',
 link: '/employees?tab=payroll',
 perm: ['view_payroll', 'manage_payroll'],
 },
 {
 id: 'nav-payments',
 label: 'nav.payments',
