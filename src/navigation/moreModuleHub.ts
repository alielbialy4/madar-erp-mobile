...
const ROUTE_GROUP: { prefix: string; group: MoreHubGroupId; description?: string }[] = [
  ...
  { prefix: '/employees?tab=attendance-records', group: 'admin', description: 'سجلات الحضور التاريخية' },
  { prefix: '/employees?tab=attendance', group: 'admin', description: 'تسجيل حضور العاملين اليومي' },
  { prefix: '/employees?tab=adjustments', group: 'admin', description: 'حوافز وخصومات الرواتب' },
  { prefix: '/employees?tab=payroll', group: 'admin', description: 'مسيرات رواتب العاملين' },
