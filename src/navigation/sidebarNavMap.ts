...
const WEB_REPORT_TO_ID: Record<string, ReportId> = {
  ...
  '/reports/sales/product-detail': 'sales-product-detail',
  '/reports/sales/by-category': 'sales-by-category',
  '/reports/sales/category-detail': 'sales-category-detail',
  '/reports/sales/refunds': 'sales-refunds',
  '/reports/sales-returns-by-product': 'sales-returns-by-product',
  '/reports/sales-returns-by-category': 'sales-returns-by-category',
  '/reports/purchase-returns-by-product': 'purchase-returns-by-product',
  '/reports/purchase-returns-by-category': 'purchase-returns-by-category',
  ...
  '/reports/operations/device-sync-manifest': 'operations-device-sync-manifest',
  '/reports/operations/drawer-reconciliation': 'operations-drawer-reconciliation',
...
export const WEB_LINK_TO_MOBILE_NAV: Record<string, SidebarNavAction | undefined> = {
  ...
  '/budgets': { kind: 'more', screen: 'Budgets' },
  ...
  '/reports/sales/by-product': reportNav('/reports/sales/by-product')!,
  '/reports/sales/product-detail': reportNav('/reports/sales/product-detail')!,
  '/reports/sales/by-category': reportNav('/reports/sales/by-category')!,
  '/reports/sales/category-detail': reportNav('/reports/sales/category-detail')!,
  ...
  '/reports/sales-returns-by-category': reportNav('/reports/sales-returns-by-category')!,
  '/reports/purchase-returns-by-product': reportNav('/reports/purchase-returns-by-product')!,
  '/reports/purchase-returns-by-category': reportNav('/reports/purchase-returns-by-category')!,
  ...
  '/reports/financial-accounts': { kind: 'more', screen: 'FinancialAccounts' },
  ...
  '/reports/operations/device-sync-manifest': reportNav('/reports/operations/device-sync-manifest')!,
  '/reports/operations/drawer-reconciliation': reportNav('/reports/operations/drawer-reconciliation')!,
  ...
  '/reports/overview': { kind: 'more', screen: 'Reports' },
  '/settings': { kind: 'more', screen: 'Settings' },
  '/employees': { kind: 'more', screen: 'Users' },
  '/employees?tab=attendance': { kind: 'more', screen: 'AttendanceToday' },
  '/employees?tab=attendance-records': { kind: 'more', screen: 'AttendanceRecords' },
  '/employees?tab=adjustments': { kind: 'more', screen: 'PayrollAdjustments' },
  '/employees?tab=payroll': { kind: 'more', screen: 'PayrollRuns' },
  '/employees?tab=access': { kind: 'more', screen: 'Users' },
  '/employees?tab=roles': { kind: 'more', screen: 'Roles' },
  '/payments': { kind: 'more', screen: 'PaymentsLedger' },
  '/financial-accounts': { kind: 'more', screen: 'FinancialAccounts' },
